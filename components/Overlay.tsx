...
export const Overlay: React.FC<OverlayProps> = ({ onNavigate }) => {
    ...
    return (
        <div className="absolute top-0 left-0 w-full h-full pointer-events-none">
            ...
            <Section className="items-center md:items-start justify-center">
                <div className="max-w-5xl relative pointer-events-auto md:ml-20" data-hover>
                    ...
                    >
                        ...
                        <div className="text-gray-300 mb-8 leading-relaxed max-w-3xl text-sm md:text-base">
                            <strong className="block mb-4 text-white text-base md:text-lg">【MISSION】人の「心」を起点としたテクノロジーで新たな仕組みを創造する</strong>
